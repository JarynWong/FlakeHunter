...
import io.github.flakeEcho.analyzer.stackmatcher.analyzer.converter.NameConverter
import io.github.flakeEcho.analyzer.stackmatcher.analyzer.converter.NoOpNameConverter
import java.io.File
import java.util.*
...
//    private val log: AppLogger
    ...
    fun analyze(traceFile: File): AnalyzerResultImpl {
        val vmTraceHandler = OnVmTraceHandler(nameConverter)
...
//        private val log: AppLogger,
        ...
        override fun addMethodAction(
            ...
            if (methodAction != TraceAction.METHOD_ENTER) {
                ...
                if (stack == null) {
                    System.out.println("There are no any stack for methodId=${methodId}, thread=$thread, startTime=$globalTime")
                } else {
                    ...
                    if (stack.isNotEmpty()) {
                        ...
                        System.out.println("Action $methodAction but stack is empty for thread=$threadId, startTime=$globalTime\"")
                    }
                }
            }
